...
@override
  void initState() {
    ...
    _cargarHostorial(chatService.usuarioPara!.uid);
  }

  void _cargarHostorial( String usuarioId) async{
        ...
        title: Column(
            children: [
              CircleAvatar(
                ...
                maxRadius: 14,
                child: Text(usuarioPara!.nombre.substring(0,2), style: TextStyle(fontSize: 12, color: Colors.blue)
                ),
              ),
              SizedBox(height: 3),
